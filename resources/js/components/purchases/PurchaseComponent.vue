<template>
    <div class="grid md:grid-cols-5 md:grid-rows-2 gap-4 mt-24 md:mt-32">
        <div class="col-span-2 row-span-1  bg-white rounded px-2 py-2  shadow border-gray-400 border">
            ...
            <div class="grid md:grid-cols-1 text-center">
                <p class="text-xl text-gray-800 mb-2">
                    <span class="text-2xl">Total Compra:</span> <span class="text-2xl font-semibold">${{
                ...
                <p class="text-xl text-gray-800 mb-4">
                    <span class="text-2x text-gray-600">Status:</span> <span class="text-2x text-blue-600 font-semibold">{{ translateStatus }}</span>
                </p>
                <div class="w-full">
